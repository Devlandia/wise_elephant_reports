START TRANSACTION;
	CREATE table reports.orders_by_day
		SELECT
	...
	CREATE INDEX reports_order_by_day_order_type_idx ON reports.orders_by_day(order_type) USING BTREE;
	CREATE INDEX reports_order_by_day_destination_id_idx ON reports.orders_by_day(destination_id) USING BTREE;
	CREATE INDEX reports_order_by_day_tracker_id_idx ON reports.orders_by_day(tracker_id) USING BTREE;
COMMIT;